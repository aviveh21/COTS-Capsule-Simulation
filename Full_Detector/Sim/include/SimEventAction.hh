...
//
//
/// \file optical/Sim/include/SimEventAction.hh
/// \brief Definition of the SimEventAction class
//

#ifndef SimEventAction_h
#define SimEventAction_h 1
...
class SimEventAction : public G4UserEventAction
{
  public:
    ...
    SimEventAction(const SimDetectorConstruction*);
    virtual ~SimEventAction();
  ...
  private:
    ...
    SimEventMessenger* fEventMessenger;
    const SimDetectorConstruction* fDetector;
