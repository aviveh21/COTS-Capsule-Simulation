...
//
//
/// \file optical/Sim/include/SimPMTSD.hh
/// \brief Definition of the SimPMTSD class
//
//
#ifndef SimPMTSD_h
#define SimPMTSD_h 1
...
class SimPMTSD : public G4VSensitiveDetector
{

  public:

    SimPMTSD(G4String name);
    virtual ~SimPMTSD();
  ...
  private:
    ...
    SimPMTHitsCollection* fPMTHitCollection;
