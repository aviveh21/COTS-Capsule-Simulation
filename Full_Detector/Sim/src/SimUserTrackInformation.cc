...
//
//
/// \file optical/Sim/src/SimUserTrackInformation.cc
/// \brief Implementation of the SimUserTrackInformation class
//
//
...
SimUserTrackInformation::SimUserTrackInformation()
...
void SimUserTrackInformation::AddTrackStatusFlag(int s)
{
