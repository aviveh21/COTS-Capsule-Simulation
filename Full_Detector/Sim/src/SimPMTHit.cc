...
//
//
/// \file optical/Sim/src/SimPMTHit.cc
/// \brief Implementation of the SimPMTHit class
//
//
...
G4ThreadLocal G4Allocator<SimPMTHit>* SimPMTHitAllocator=0;
...
SimPMTHit::SimPMTHit(const SimPMTHit &right) : G4VHit()
{
...
const SimPMTHit& SimPMTHit::operator=(const SimPMTHit &right){
  fPmtNumber = right.fPmtNumber;
  fPhotons=right.fPhotons;
  fPhysVol=right.fPhysVol;
  fDrawit=right.fDrawit;
...
G4bool SimPMTHit::operator==(const SimPMTHit &right) const{
