...
// ********************************************************************
//
/// \file optical/Sim/src/SimHistoManager.cc
/// \brief Implementation of the SimHistoManager class
//
//
// 
...
SimHistoManager::SimHistoManager()
  : fFileName("sim")
{
  Book();
}
...
void SimHistoManager::Book()
{
  // Create or get analysis manager
  // The choice of analysis technology is done via selection of a namespace
  // in SimHistoManager.hh
