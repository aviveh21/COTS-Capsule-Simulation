...
//
//
/// \file optical/Sim/src/SimTrajectory.cc
/// \brief Implementation of the SimTrajectory class
//
//
...
SimTrajectory::SimTrajectory(const G4Track* aTrack)
...
SimTrajectory::SimTrajectory(SimTrajectory &right)
...
void SimTrajectory::DrawTrajectory() const
{
